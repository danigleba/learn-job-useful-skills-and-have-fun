  ...
  return (
    <>
      ...
      <nav className="my-3 mx-12">
        ...
        <div className='mx-4'>
            <p className='text-center flex justify-center pt-12 font-extrabold text-[#333533] text-3xl'>{user?.username}, tu suscripción ha caducado.</p><p className='text-center flex justify-center pt-2 font-extrabold text-[#333533] text-3xl'>Suscríbete para seguir disfrutando de Kualify Premium.</p>
            <p className='text-center pt-4 flex justify-center font-light text-lg text-[#333533]'>Para seguir usando la misma cuenta, suscríbete con tu email: {user.email}</p>
          </div>
