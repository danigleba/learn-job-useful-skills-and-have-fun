    ...
    <a key={item.id}>
      <div className=' h-full bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-xl p-4 flex flex-col'>
        <div className='flex justify-center gap-2'>
          <div className='w-max h-max justify-center flex bg-[#f4f4f4] rounded-md px-4 w-full px-3 py-1.5 text-[#333533] text-md font-semibold text-center'>
          ...
          <div className='w-max justify-center flex bg-[#f4f4f4] rounded-md px-4 w-full px-3 py-1.5 text-[#333533] text-md font-semibold text-center'>
