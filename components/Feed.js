...
export default function Feed() {
    ...
    return (
        <>   {/*     
         <div className={`flex justify-center ${feedLoading ? "" : "hidden"}`}>
            <div className="mt-12 space-y-12 md:space-y-0 md:grid md:grid-cols-2 gap-12 justify-center w-full lg:w-2/3">
                <div className="w-full bg-gray-200 animate-pulse shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-xl pb-10">
                    <div className="flex rounded-xl justify-center h-56">
                        </div>                                            
                ...
                <div className="mt-12 w-full bg-gray-200 animate-pulse shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-xl pb-10">
                    <div className="flex rounded-xl justify-center h-56">
                        </div>                                            
                        <div className="px-6 py-6 text-center">
                        </div>
        ...
        <div className='flex justify-center'>
                    ...
                    {courses?.map(item => (
                                <a href={"/cursos/"+item.id} key={item.id} className={`${(item.tag != "Course" ? "hidden" : "" )}`}>
